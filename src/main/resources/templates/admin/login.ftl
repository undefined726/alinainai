...
<body class="blue-bg" id="particles">
    <div class="middle-box text-center loginscreen animated fadeInDown" style="margin-top: -570px;">
        <div>
            ...
            <form class="m-t" role="form" id="frm" action="${ctx!}/login" method="POST">
                ...
                <#--<p class="text-muted text-center"> <a href="login2.html#"><small>忘记密码了？</small></a> | <a href="register.html">注册一个新账号</a>
                </p>-->
            </form>
        </div>
    </div>
    ...
    <!-- particle javascript-->
    <script src="${ctx!}/admin/js/plugins/particle/jquery.particleground.js"></script>
