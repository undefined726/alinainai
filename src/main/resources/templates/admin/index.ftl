                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" style="width:100px; height: 100px;" class="img-circle" src="${ctx!}/admin/img/avatar.jpg" /></span>
                        ...
                        <div class="logo-element">${siteName!}</div>
                    </li>
                    <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                        <span class="ng-scope">莫欺少年穷~by 到老了还是穷</span>
                    </li>
                    <li>
